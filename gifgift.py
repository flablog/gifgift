...
class MainHandler(tornado.web.RequestHandler):
    ...
    def get(self):
        ...
        days = [ # ['gifName', 'YYYY-MM-DD HH:MM' Starting point hour', 'author', active, date, state] 
                ['Geoffroi_02.gif','2013-11-30 10:00', 'joseph', False, 10, False],
                ...
                ['GIF2.gif','2013-11-30 14:00', 'peter', False, 14, False],
                
                ['GIF1.gif','2013-11-30 04:00', 'gaelle', False, 4, False],
                ['6_max_camap.gif','2013-11-30 06:00', 'marie', False, 6, False],
                ['Geoffroi_01.gif','2013-11-30 01:00', 'joseph', False, 1, False],
                ['night.gif','2013-11-30 20:00', 'joseph', False, 20, False],
                ['GIF4.gif','2013-11-30 08:00', 'joseph', False, 8, False],
                ['GIF_france.gif','2013-11-30 23:00', 'joseph', False, 23, False],
                
                ['present.gif','2013-11-30 21:00', 'joseph', False, 21, False],
                ['gif-playa150x108.gif','2013-11-30 02:00', 'joseph', False, 2, False],
                ...
                ['GIF_groenland.gif','2013-11-30 07:00', 'joseph', False, 7, False],
                
                ['gif-cadeau150x108.gif','2013-11-30 16:00', 'joseph', False, 16, False],
                ['Xmas_triangle.gif','2013-11-30 18:00', 'joseph', False, 18, False],
                ['GIF3.gif','2013-11-30 09:00', 'joseph', False, 9, False],
                ['gif-festin-anim-B-150x108.gif','2013-11-30 05:00', 'joseph', False, 5, False],
                ['Xmas_tree_watercolor.gif','2013-11-30 19:00', 'joseph', False, 19, False],
